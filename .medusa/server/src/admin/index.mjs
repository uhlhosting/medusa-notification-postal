...
import { clx, Container, Heading, StatusBadge, Text, Button, createDataTableColumnHelper, useDataTable, DataTable, InlineTip, Code, toast, Badge, Label, Table, Select, Input } from "@medusajs/ui";
import { useQuery, useMutation } from "@tanstack/react-query";
import { useState, useMemo, useEffect } from "react";
import { useTranslation } from "react-i18next";
import { Envelope, CheckCircle, XCircle, PaperPlane } from "@medusajs/icons";
...
const SingleColumnLayout = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: clx("flex min-w-0 flex-col gap-y-3", className), children });
};
...
const PluginHeader = ({
  ...
  return /* @__PURE__ */ jsxs(Container, { className: clx("divide-y p-0", className), children: [
    /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-4 px-4 py-4 sm:px-6 md:flex-row md:items-start md:justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-y-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsx(Heading, { level: "h1", children: title }),
          statusLabel && /* @__PURE__ */ jsx(StatusBadge, { color: statusColor, children: statusLabel })
        ] }),
        ...
        lastSuccessfulExecution && /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: lastSuccessfulExecution })
      ] }),
      actions && /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center gap-2", children: actions })
    ] }),
    helpLinks.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex min-w-0 flex-wrap items-center gap-2 px-4 py-3 sm:px-6", children: helpLinks.map((link) => /* @__PURE__ */ jsx(Button, { asChild: true, size: "small", variant: "transparent", children: /* @__PURE__ */ jsx("a", { href: link.href, target: "_blank", rel: "noreferrer", children: link.label }) }, link.href)) })
  ] });
};
...
const PluginStatusCard = ({
  ...
  return /* @__PURE__ */ jsx(Container, { className: clx("divide-y p-0", className), children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4 px-6 py-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-y-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        Icon && /* @__PURE__ */ jsx(Icon, { className: clx("size-4", statusColorClass(color)) }),
        /* @__PURE__ */ jsx(
          Text,
          {
            size: "small",
      ...
      /* @__PURE__ */ jsx(Text, { as: "div", size: "xlarge", leading: "compact", weight: "plus", children: value }),
      description && /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: description })
    ] }),
    statusLabel && /* @__PURE__ */ jsx(StatusBadge, { color, children: statusLabel })
  ] }) });
};
const PluginSection = ({
  title,
  ...
  return /* @__PURE__ */ jsxs(Container, { className: clx("divide-y p-0", className), children: [
    /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-3 px-4 py-4 sm:px-6 md:flex-row md:items-start md:justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-y-1", children: [
    ...
    children && /* @__PURE__ */ jsx("div", { className: clx("min-w-0 px-4 py-4 sm:px-6", bodyClassName), children })
  ] });
};
const PluginSidebarSection = ({
  ...
  return /* @__PURE__ */ jsxs(Container, { className: clx("divide-y p-0", className), children: [
    /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 items-center gap-x-2 px-4 py-4 text-ui-fg-subtle sm:px-6", children: [
      icon,
      /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: title })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "min-w-0 px-4 py-4 sm:px-6", children })
  ] });
};
...
const webhookColumnHelper = createDataTableColumnHelper();
  ...
  return useMemo(
    () => [
      columnHelper.accessor("to", {
        ...
        cell: ({ getValue }) => /* @__PURE__ */ jsx(Text, { size: "small", children: sanitizeEmailDisplay(getValue()) })
      }),
      ...
      columnHelper.accessor("id", {
        ...
        cell: ({ row }) => {
          ...
          return /* @__PURE__ */ jsx(StatusBadge, { color: statusBadgeColor(status), children: t(statusLabelKey(status)) });
        }
      })
    ],
    [t]
  ...
  return useMemo(
    () => [
      ...
      webhookColumnHelper.accessor("status", {
        ...
        cell: ({ getValue }) => /* @__PURE__ */ jsx(StatusBadge, { color: webhookStatusBadgeColor(getValue()), children: t(webhookStatusLabelKey(getValue())) })
      }),
      ...
      webhookColumnHelper.accessor("created_at", {
        ...
        cell: ({ getValue }) => /* @__PURE__ */ jsx(Text, { size: "small", children: getValue() ? new Date(getValue()).toLocaleString() : "-" })
      })
    ],
    [t]
  );
...
const PostalAdminPage = () => {
  ...
  const { data: webhookEventsData, isLoading: isWebhookEventsLoading } = useQuery({
  ...
  return /* @__PURE__ */ jsxs(PluginShell, { children: [
    /* @__PURE__ */ jsx(
      PluginHeader,
      {
    ...
    /* @__PURE__ */ jsx(
      PluginSection,
      {
        ...
        bodyClassName: "p-0",
        children: /* @__PURE__ */ jsxs(DataTable, { instance: table, children: [
          /* @__PURE__ */ jsx(DataTable.Toolbar, { children: /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: /* @__PURE__ */ jsx(
            DataTable.Search,
            {
    ...
    /* @__PURE__ */ jsx(
      PluginSection,
      {
        ...
        bodyClassName: "p-0",
        children: /* @__PURE__ */ jsx(DataTable, { instance: webhookTable, children: /* @__PURE__ */ jsx(DataTable.Table, {}) })
      }
    ),
    /* @__PURE__ */ jsxs(InlineTip, { label: t("postal.activity.workflow_metadata"), children: [
      t("postal.activity.workflow_hint_prefix"),
      " ",
      /* @__PURE__ */ jsx(Code, { children: "provider_data.workflow_event" }),
      " ",
      t("postal.activity.workflow_hint_middle"),
      " ",
      /* @__PURE__ */ jsx(Code, { children: "provider_data.workflow_run_id" }),
      " ",
      t("postal.activity.workflow_hint_suffix")
    ] }),
    /* @__PURE__ */ jsxs(InlineTip, { label: t("postal.webhooks.endpoint"), children: [
      t("postal.webhooks.endpoint_hint_prefix"),
      " ",
      /* @__PURE__ */ jsx(Code, { children: webhookCallbackPath }),
      " ",
      t("postal.webhooks.endpoint_hint_suffix")
    ] }),
    /* @__PURE__ */ jsx(InlineTip, { label: t("postal.webhooks.callback_url"), children: webhookCallbackUrl ? /* @__PURE__ */ jsxs(Fragment, { children: [
      t("postal.webhooks.callback_url_hint_prefix"),
      " ",
      /* @__PURE__ */ jsx(Code, { children: webhookCallbackUrl }),
      " ",
...
const config$1 = defineRouteConfig({
  ...
  icon: function PostalRouteIcon() {
    return /* @__PURE__ */ jsxs("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
      /* @__PURE__ */ jsx("rect", { width: "15", height: "15", fill: "#F43F5E" }),
      /* @__PURE__ */ jsx("rect", { width: "15", height: "15", fill: "url(#postal-admin-icon-gradient)", fillOpacity: "0.2" }),
      /* @__PURE__ */ jsxs("g", { transform: "translate(2 2) scale(0.7)", stroke: "white", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", children: [
        /* @__PURE__ */ jsx("path", { d: "M11.829 4.398a2.82 2.82 0 0 1 1.511 2.498v4.028c0 .444-.36.805-.805.805H6.493M4.48 4.077h4.832" }),
        /* @__PURE__ */ jsx("path", { d: "M4.48 4.077a2.82 2.82 0 0 1 2.819 2.82v4.027c0 .444-.361.805-.806.805H2.465a.806.806 0 0 1-.805-.805V6.896a2.82 2.82 0 0 1 2.82-2.82M7.299 11.528v1.812M4.48 6.896v1.208" }),
        /* @__PURE__ */ jsx("path", { fill: "white", d: "M11.73.854H9.311v1.209h2.417z" }),
        /* @__PURE__ */ jsx("path", { d: "M9.313 5.285V1.86" })
      ] }),
      /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "postal-admin-icon-gradient", x1: "7.5", y1: "0", x2: "7.5", y2: "15", gradientUnits: "userSpaceOnUse", children: [
...
const SummaryCard = ({ label, value }) => /* @__PURE__ */ jsxs("div", { className: "min-w-0 rounded-lg border border-ui-border-base bg-ui-bg-subtle p-3", children: [
  /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: label }),
  /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", className: "break-words", children: value })
] });
const SettingsField = ({
  label,
  value,
  ...
  hint ? /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "break-words text-ui-fg-subtle", children: hint }) : null
] });
...
const PostalSettingsPage = () => {
  ...
  const [templateAudienceFilter, setTemplateAudienceFilter] = useState("all");
  ...
  const saveMutation = useMutation({
    ...
    onError: (err) => {
      toast.error((err == null ? void 0 : err.message) || t("postal.toast.save_failed"));
    }
  });
  const testMutation = useMutation({
    ...
    onError: (err) => {
      toast.error((err == null ? void 0 : err.message) || t("postal.toast.test_failed"));
    }
  });
  ...
  return /* @__PURE__ */ jsxs(PluginShell, { children: [
    ...
    /* @__PURE__ */ jsx(Container, { className: "p-0", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-4 px-6 py-5 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsx(Badge, { color: isConfigured ? "green" : "grey", size: "small", children: isConfigured ? t("postal.configured") : t("postal.not_configured") }),
          /* @__PURE__ */ jsx(Badge, { color: "grey", size: "small", children: "smtp-api" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-y-1", children: [
          /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: "Configure Postal delivery and test routing from one place." }),
          /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: "Keep credentials in the settings form, keep webhook URLs in the callback view, and use the test panel to validate delivery end to end." })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3", children: configuredSummary.map((item) => /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-ui-border-base bg-ui-bg-subtle p-3", children: [
        /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: item.label }),
        /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", className: "break-words", children: item.value })
      ] }, item.label)) })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "grid min-w-0 gap-4 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] xl:items-start", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-4", children: [
        /* @__PURE__ */ jsxs(
          PluginSection,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "grid min-w-0 gap-3 md:grid-cols-3", children: [
                /* @__PURE__ */ jsx(SummaryCard, { label: "Delivery mode", value: "Postal API only" }),
                /* @__PURE__ */ jsx(
                  SummaryCard,
                  {
                ...
                /* @__PURE__ */ jsx(SummaryCard, { label: "Webhook URL", value: webhookCallbackUrl })
              ] }),
              /* @__PURE__ */ jsx(
                SettingsField,
                {
              ...
              /* @__PURE__ */ jsx("div", { className: "flex justify-stretch border-t pt-4 sm:justify-end", children: /* @__PURE__ */ jsx(
                Button,
                {
                  variant: "primary",
                  size: "small",
        ...
        /* @__PURE__ */ jsx(PluginSidebarSection, { title: t("postal.webhook_callback"), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-3", children: [
          /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: "Postal should POST delivery and tracking events to this exact URL." }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "postal-webhook-callback", children: t("postal.webhook_callback_url") }),
            /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-2 sm:flex-row sm:items-center", children: [
              /* @__PURE__ */ jsx(
                Code,
                {
          ...
          /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: "Keep this URL in Postal and do not paste it into the settings form." })
        ] }) }),
        (data == null ? void 0 : data.configured) && /* @__PURE__ */ jsx(PluginSidebarSection, { title: t("postal.active_config_checklist"), children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-3", children: [
          /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: "The following values are saved and used by the provider at runtime." }),
          /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsx(Table, { children: /* @__PURE__ */ jsx(Table.Body, { children: checklistRows.map((row) => /* @__PURE__ */ jsxs(Table.Row, { children: [
            /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: row.label }) }),
            /* @__PURE__ */ jsx(Table.Cell, { className: "text-right", children: row.key === "api_key" ? /* @__PURE__ */ jsx(StatusBadge, { color: data.configured.api_key ? "green" : "red", children: data.configured.api_key ? t("postal.set") : t("postal.missing") }) : /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "break-all", children: row.value || t("postal.missing") }) })
          ] }, row.key)) }) }) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex min-w-0 flex-col gap-4 xl:sticky xl:top-4", children: /* @__PURE__ */ jsxs(
        PluginSection,
        {
          ...
          bodyClassName: "flex flex-col gap-4",
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col items-stretch gap-3 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-y-1", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: templatePreview.label }),
                /* @__PURE__ */ jsx(
                  Text,
                  {
                    size: "small",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center", children: [
                /* @__PURE__ */ jsx(
                  Button,
                  {
                    variant: "secondary",
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-template", children: t("postal.template") }),
              /* @__PURE__ */ jsxs(
                Select,
                {
                  ...
                  disabled,
                  children: [
                    /* @__PURE__ */ jsx(Select.Trigger, { id: "postal-test-template", children: /* @__PURE__ */ jsx(Select.Value, { placeholder: t("postal.template") }) }),
                    /* @__PURE__ */ jsx(Select.Content, { children: templateOptions.map((option) => /* @__PURE__ */ jsx(Select.Item, { value: option.value, children: option.label }, option.value)) })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 rounded-full border border-ui-border-base bg-ui-bg-subtle p-1 sm:inline-flex sm:w-fit", children: ["rendered", "source", "example"].map((mode) => /* @__PURE__ */ jsx(
              Button,
              {
                type: "button",
                size: "small",
            ...
            previewMode === "rendered" && /* @__PURE__ */ jsxs("div", { className: "overflow-hidden rounded-xl border border-ui-border-base bg-white shadow-sm", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-3 border-b border-ui-border-base bg-ui-bg-subtle px-4 py-3 sm:flex-row sm:items-center sm:justify-between", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-y-1", children: [
                  /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: t("postal.template_rendered_preview") }),
                  /* @__PURE__ */ jsx(
                    Text,
                    {
                      size: "small",
                ...
                /* @__PURE__ */ jsx(Badge, { size: "small", color: "grey", className: "shrink-0", children: templatePreview.label })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "border-b border-ui-border-base bg-ui-bg-subtle px-4 py-3", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-3 md:grid-cols-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-ui-border-base bg-ui-bg-base p-3", children: [
                  /* @__PURE__ */ jsx(
                    Text,
                    {
                      size: "small",
                  ...
                  /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", className: "break-words", children: templatePreview.subject })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-ui-border-base bg-ui-bg-base p-3", children: [
                  /* @__PURE__ */ jsx(
                    Text,
                  ...
                  /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "break-words", children: templatePreview.text || t("postal.template_empty") })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-ui-border-base bg-ui-bg-base p-3", children: [
                  /* @__PURE__ */ jsx(
                    Text,
                  ...
                  /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", className: "break-all", children: form.test_to || t("postal.recipient_fallback") })
                ] })
              ] }) }),
              /* @__PURE__ */ jsx("div", { className: "bg-white", children: renderedTemplateHtml ? /* @__PURE__ */ jsx(
                "iframe",
                {
              ...
              ) : /* @__PURE__ */ jsx("div", { className: "flex h-[420px] items-center justify-center p-6 text-center", children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: t("postal.template_empty") }) }) })
            ] }),
            previewMode === "source" && /* @__PURE__ */ jsxs("div", { className: "grid gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-ui-border-base bg-ui-bg-subtle p-4", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: t("postal.template_subject") }),
                /* @__PURE__ */ jsx(Code, { className: "mt-2 block whitespace-pre-wrap break-words", children: templatePreview.subject })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-ui-border-base bg-ui-bg-subtle p-4", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: t("postal.template_text") }),
                /* @__PURE__ */ jsx(Code, { className: "mt-2 block whitespace-pre-wrap break-words", children: templatePreview.text || t("postal.template_empty") })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-ui-border-base bg-ui-bg-subtle p-4", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: t("postal.template_html") }),
                /* @__PURE__ */ jsx(Code, { className: "mt-2 block max-h-[480px] overflow-auto whitespace-pre-wrap break-all", children: templatePreview.html || t("postal.template_empty") })
              ] })
            ] }),
            previewMode === "example" && /* @__PURE__ */ jsx("div", { className: "grid gap-4", children: /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-ui-border-base bg-ui-bg-subtle p-4", children: [
              /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: t("postal.template_example") }),
              /* @__PURE__ */ jsx(Code, { className: "mt-2 block max-h-[720px] overflow-auto whitespace-pre-wrap break-all", children: JSON.stringify(templateExampleForUi, null, 2) })
            ] }) })
          ]
        }
      ) })
      ...
      PluginSection,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsx(Badge, { size: "small", color: "blue", className: "w-fit", children: "auth only" }),
            /* @__PURE__ */ jsx(Badge, { size: "small", color: "green", className: "w-fit", children: "commerce only" }),
            /* @__PURE__ */ jsx(Badge, { size: "small", color: "orange", className: "w-fit", children: "ops only" }),
            /* @__PURE__ */ jsx(Badge, { size: "small", color: "grey", className: "w-fit", children: "shared fallback" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid gap-4 lg:grid-cols-[minmax(0,280px)_minmax(0,1fr)]", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex max-w-sm flex-col gap-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "postal-template-audience-filter", children: "Filter by audience" }),
                /* @__PURE__ */ jsxs(
                  Select,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(Select.Trigger, { id: "postal-template-audience-filter", children: /* @__PURE__ */ jsx(Select.Value, { placeholder: "All templates" }) }),
                      /* @__PURE__ */ jsxs(Select.Content, { children: [
                        /* @__PURE__ */ jsx(Select.Item, { value: "all", children: "All templates" }),
                        /* @__PURE__ */ jsx(Select.Item, { value: "auth", children: "Auth" }),
                        /* @__PURE__ */ jsx(Select.Item, { value: "commerce", children: "Commerce" }),
                        /* @__PURE__ */ jsx(Select.Item, { value: "ops", children: "Ops" }),
                        /* @__PURE__ */ jsx(Select.Item, { value: "shared", children: "Shared" })
                      ] })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex max-w-xl flex-col gap-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "postal-template-search", children: "Search templates" }),
                /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-col gap-2 sm:flex-row sm:items-center", children: [
                  /* @__PURE__ */ jsx(
                    Input,
                    {
            ...
            /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-lg border border-ui-border-base bg-white", children: /* @__PURE__ */ jsx(Table, { className: "min-w-[920px]", children: /* @__PURE__ */ jsx(Table.Body, { children: filteredTemplateRows.length ? filteredTemplateRows.map((row) => /* @__PURE__ */ jsxs(Table.Row, { children: [
              /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-1", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: row.template }),
                /* @__PURE__ */ jsx(
                  Text,
                  {
                    size: "small",
              ...
              /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-1", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: "Required" }),
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", children: row.required })
              ] }) }),
              /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-1", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: "Optional" }),
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", children: row.optional })
              ] }) }),
              /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-1", children: [
                /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: "Source" }),
                /* @__PURE__ */ jsx(
                  Text,
                  {
                    size: "small",
              ...
              /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-1", children: [
                ...
                /* @__PURE__ */ jsx(Code, { className: "block whitespace-pre-wrap break-words", children: row.event })
              ] }) }),
              ...
              /* @__PURE__ */ jsx(Table.Cell, { className: "text-right", children: /* @__PURE__ */ jsx(
                Button,
                {
                  type: "button",
                  size: "small",
            ...
            ] }, row.template)) : /* @__PURE__ */ jsx(Table.Row, { children: /* @__PURE__ */ jsx(Table.Cell, { ...{ colSpan: 7 }, children: /* @__PURE__ */ jsxs("div", { className: "py-6 text-center", children: [
              /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: "No templates match the current filter." }),
              /* @__PURE__ */ jsx(
                Text,
                {
                  size: "small",
      ...
      PluginSection,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2 md:col-span-2", children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-to", children: t("postal.recipient_address") }),
              /* @__PURE__ */ jsx(
                Input,
                {
                  id: "postal-test-to",
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2 md:col-span-2", children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-subject", children: t("postal.template_subject") }),
              /* @__PURE__ */ jsx(
                Input,
                {
          ...
          /* @__PURE__ */ jsxs("details", { className: "rounded-xl border border-ui-border-base bg-ui-bg-subtle", children: [
            /* @__PURE__ */ jsx("summary", { className: "cursor-pointer px-4 py-3 text-sm font-medium text-ui-fg-base", children: "Advanced payload" }),
            /* @__PURE__ */ jsxs("div", { className: "grid gap-4 border-t border-ui-border-base p-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                  /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-from-name", children: t("postal.sender_name") }),
                  /* @__PURE__ */ jsx(
                    Input,
                    {
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                  /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-reply-to", children: t("postal.reply_to") }),
                  /* @__PURE__ */ jsx(
                    Input,
                    {
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                  /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-cc", children: t("postal.cc") }),
                  /* @__PURE__ */ jsx(
                    Input,
                    {
                      id: "postal-test-cc",
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                  /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-bcc", children: t("postal.bcc") }),
                  /* @__PURE__ */ jsx(
                    Input,
                    {
                      id: "postal-test-bcc",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-text", children: t("postal.template_text") }),
                /* @__PURE__ */ jsx(
                  "textarea",
                  {
                    id: "postal-test-text",
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-html", children: t("postal.template_html") }),
                /* @__PURE__ */ jsx(
                  "textarea",
                  {
                    id: "postal-test-html",
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                  /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-headers", children: t("postal.headers") }),
                  /* @__PURE__ */ jsx(
                    "textarea",
                    {
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                  /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-custom-args", children: t("postal.custom_args") }),
                  /* @__PURE__ */ jsx(
                    "textarea",
                    {
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "postal-test-metadata", children: t("postal.metadata") }),
                /* @__PURE__ */ jsx(
                  "textarea",
                  {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 md:flex-row md:items-center md:justify-between", children: [
            /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: selectedTemplate == null ? void 0 : selectedTemplate.description }),
            /* @__PURE__ */ jsxs(
              Button,
              {
                variant: "secondary",
...
const PostalPluginSettingsRedirect = () => /* @__PURE__ */ jsx(Navigate, { to: "/settings/postal", replace: true });
const config = defineRouteConfig({
  label: "Postal",
  icon: function PostalRouteIcon2() {
    return /* @__PURE__ */ jsxs("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
      /* @__PURE__ */ jsx("rect", { width: "15", height: "15", fill: "#F43F5E" }),
      /* @__PURE__ */ jsx("rect", { width: "15", height: "15", fill: "url(#postal-settings-icon-gradient)", fillOpacity: "0.2" }),
      /* @__PURE__ */ jsxs("g", { transform: "translate(2 2) scale(0.7)", stroke: "white", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", children: [
        /* @__PURE__ */ jsx("path", { d: "M11.829 4.398a2.82 2.82 0 0 1 1.511 2.498v4.028c0 .444-.36.805-.805.805H6.493M4.48 4.077h4.832" }),
        /* @__PURE__ */ jsx("path", { d: "M4.48 4.077a2.82 2.82 0 0 1 2.819 2.82v4.027c0 .444-.361.805-.806.805H2.465a.806.806 0 0 1-.805-.805V6.896a2.82 2.82 0 0 1 2.82-2.82M7.299 11.528v1.812M4.48 6.896v1.208" }),
        /* @__PURE__ */ jsx("path", { fill: "white", d: "M11.73.854H9.311v1.209h2.417z" }),
      ...
      /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "postal-settings-icon-gradient", x1: "7.5", y1: "0", x2: "7.5", y2: "15", gradientUnits: "userSpaceOnUse", children: [
        /* @__PURE__ */ jsx("stop", { stopColor: "white" }),
        /* @__PURE__ */ jsx("stop", { offset: "1", stopColor: "white", stopOpacity: "0" })
      ] }) })
    ] });
